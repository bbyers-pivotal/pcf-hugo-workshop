...
First push a new version of the app with a blue route.
    ...
    $ cf map-route <YOUR INITIALS>-env-v1 apps.azure.pcf.cloud --hostname <YOUR INITIALS>-env
...
Next, you can push a new version of the app with a green route.
    ...
    $ cf map-route <YOUR INITIALS>-env-v2 apps.azure.pcf.cloud --hostname <YOUR INITIALS>-env
    // Unmap the outside route to the blue version. All the traffic is now directed to v2
    $ cf unmap-route <YOUR INITIALS>-env-v1 apps.azure.pcf.cloud --hostname <YOUR INITIALS>-env
